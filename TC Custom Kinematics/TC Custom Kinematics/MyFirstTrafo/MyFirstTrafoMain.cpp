...
class CMyFirstTrafoCtrl : public ITcOCFCtrlImpl<CMyFirstTrafoCtrl, CMyFirstTrafoClassFactory>
{
public:
	CMyFirstTrafoCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("MyFirstTrafo: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CMyFirstTrafoCtrl>;
